...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("RocksMusicMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("RocksMusicMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("RocksMusicMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("RocksMusicMusic/assets/play_icons.png")
